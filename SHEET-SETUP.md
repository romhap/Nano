...
- **The lounge itself is open** — first name + email only, no password and no
  payment check. It's a free diagnostic tool anyone can use; the €79/mo
  mentorship and the webinar are the actual paid products.
